...
class HelloTriangleApplication {
  ...
  private:
    ...
    void createVertexBuffers() {
      ...
      VkBufferUsageFlags bufferFlags = VK_MEMORY_PROPERTY_HOST_VISIBLE_BIT | VK_MEMORY_PROPERTY_HOST_COHERENT_BIT;

      createBuffer(bufferSize, VK_BUFFER_USAGE_TRANSFER_SRC_BIT, bufferFlags, stagingBuffer, stagingBufferMemory);
    ...
    void createTextureImage() {
      ...
      createImage(static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight), mipLevels, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_TILING_OPTIMAL, VK_IMAGE_USAGE_TRANSFER_SRC_BIT | VK_IMAGE_USAGE_TRANSFER_DST_BIT | VK_IMAGE_USAGE_SAMPLED_BIT, VK_MEMORY_PROPERTY_DEVICE_LOCAL_BIT, textureImage, textureImageMemory);
